...
import java.util.List;
    ...
    public ContactAdapter(Context context, ArrayList<ContactModel>
    ...
    public ContactViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
        ...
        View view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.item_contact, parent,
                        false);
    ...
    public void setOnItemClickListener(ContactAdapter.ClickListener
