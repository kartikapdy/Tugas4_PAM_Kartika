...
public class ContactActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        contactList.add(new ContactModel("Jusuf Latifah", "+62878555504",

                "bussines", "bayerhilarious"));

        contactList.add(new ContactModel("Burhanuddin Taufik",

                "+628785555041", "family", "integersjunior"));

        contactList.add(new ContactModel("Latifah Bagus", "+628785555042",

                "study", "clearcarbon"));

        contactList.add(new ContactModel("Agung Nurul", "+628785555043",

                "family", "opticalwwf"));

        contactList.add(new ContactModel("Cahaya Krisna", "+628785555044",
